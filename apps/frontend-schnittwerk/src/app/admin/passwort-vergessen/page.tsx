...
export const metadata: Metadata = {
  title: 'Admin Passwort vergessen | BeautifyPRO',
  robots: { index: false, follow: false },
};

export default function AdminPasswordForgottenPage() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-beauty p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md animate-fade-in">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">Admin-Passwort zurücksetzen</p>
        </div>

        <div className="card-elegant p-8 rounded-2xl">
          <PasswordResetForm
            returnHref="/admin/login"
            returnLabel="Zurück zur Admin-Anmeldung"
            resetRedirectPath="/admin/passwort-aendern"
          />
        </div>
