...
export default function GutscheinePage() {
  ...
  // Handle custom amount change - strip decimals
  const handleCustomAmountChange = (value: string) => {
    const intOnly = value.replace(/[^0-9]/g, '');
    setCustomAmount(intOnly);
    setSelectedAmount(null);
  };

  // On blur: round up to nearest 5
            ...
            <Card className="card-elegant overflow-hidden">
              ...
              <CardContent className="p-6">
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-xs text-muted-foreground">Mindestbetrag CHF 25, Maximum CHF 500 (in 5er-Schritten)</p>
                </div>
              </CardContent>
            </Card>
