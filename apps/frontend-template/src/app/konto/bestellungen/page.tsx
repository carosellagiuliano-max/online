...
function getStatusBadge(status: OrderStatus) {
  ...
  > = {
    ...
    paid: { label: 'Bezahlt', variant: 'secondary', className: 'bg-sky-500/10 text-sky-600 border-0' },
    ...
    delivered: { label: 'Geliefert', variant: 'default', className: 'bg-emerald-500/10 text-emerald-600 border-0' },
    ...
    refunded: { label: 'Erstattet', variant: 'outline', className: 'border-slate-400 text-slate-600 bg-slate-500/10' },
  };
